...
def calc_adj_rand_index(
    ...
    '''
        ...
        adata_sp1.uns[uns_key]["bin_y"] = pd.cut(adata_sp1.uns[uns_key][cells_y_col], bins=bins[0], labels=False)
        adata_sp1.uns[uns_key]["bin_x"] = pd.cut(adata_sp1.uns[uns_key][cells_x_col], bins=bins[1], labels=False)
        adata_sp2.uns[uns_key]["bin_y"] = pd.cut(adata_sp2.uns[uns_key][cells_y_col], bins=bins[0], labels=False)
        adata_sp2.uns[uns_key]["bin_x"] = pd.cut(adata_sp2.uns[uns_key][cells_x_col], bins=bins[1], labels=False)
