...
def get_celltype_density(adata_sp: ad, region_range: Tuple[Tuple[float, float], Tuple[float, float]], bins: Tuple[int, int], celltype, obs_key: str = "celltype",cells_x_col: str = "x",
